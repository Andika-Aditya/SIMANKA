...
<head>
  ...
  <title>SIMANKA - POCIK | Rekam Status</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="col-sm-12">
          <h1 class="m-0">Rekam Status Data Pegawai</h1>
      </div>
    </div>
    <!-- /.content-header -->
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <button class="btn btn-primary" data-toggle="modal" data-target="#inputModal"><i class="fa fa-plus"></i>Tambah Data Status Pegawai</button>
                  ...
                  <tbody>
                    ...
                    foreach($promosi as $promo) : ?>
                      <tr style="word_wrap: break-word;">
                        ...
                        <td align="center">
                          <a class="btn btn-success btn-sm" href="<?php echo base_url('#'.$promo->id_perubahan_riwayat)?>"><b>Validasi</b></a>
                        </td>
                        <td align="center">
