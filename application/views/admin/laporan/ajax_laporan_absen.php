    ...
    <div class="form-group col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <center>
                    <h2>DAFTAR ABSEN ANGGOTA KEPOLISIAN DI POLSEK CIKAMPEK</h2>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover responsive nowrap" width="100%">
                        <thead>
                            ...
                            <th align="center">TANGGAL HADIR/MULAI</th>
                            <th align="center">TANGGAL SELESAI</th>
                            <th align="center">JAM MASUK/AJUAN</th>
                            <th align="center">STATUS KEHADIRAN</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <?php echo date('d', strtotime($row->tanggal_kehadiran)) . ' ' . getIndonesianMonth(date('m', strtotime($row->tanggal_kehadiran))) . ' ' . date('Y', strtotime($row->tanggal_kehadiran)); ?>
                                </td>
                                <td align="center">
                                    <?php echo date('d', strtotime($row->tanggal_selesai)) . ' ' . getIndonesianMonth(date('m', strtotime($row->tanggal_selesai))) . ' ' . date('Y', strtotime($row->tanggal_selesai)); ?>
                                </td>
                                <td align="center"><?php echo $row->jam_masuk ?> WIB</td>
                                <td align="center"><?php echo $row->Status_hadir ?></td>
                                <td align="center"><?php echo $row->validasi ?></td>
