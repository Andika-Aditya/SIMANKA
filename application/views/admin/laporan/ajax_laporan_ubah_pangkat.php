    ...
    <div class="form-group col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <center>
                    <h2>DAFTAR PERUBAHAN PANGKAT ANGGOTA KEPOLISIAN DI POLSEK CIKAMPEK</h2>
                    ...
                    <table class="table table-bordered table-striped table-hover responsive nowrap" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <?php echo date('d', strtotime($row->Tgl_perubahan_pangkat  )) . ' ' . getIndonesianMonth(date('m', strtotime($row->Tgl_perubahan_pangkat   ))) . ' ' . date('Y', strtotime($row->Tgl_perubahan_pangkat )); ?>
                                </td>
                                <td align="center"><?php echo $row->Jenis_perubahan ?></td>
