...
<head>
    ...
    <title>SIMANKA | Ubah Kata Sandi - Admin</title>
            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card shadow-2-strong" style="border-radius: 1.5rem;">
                        ...
                        <div class="card-body ">
                            <?php echo form_open_multipart('Admin/Ubah_sandi'); ?>
                            <div class="form-group">
                                <input type="hidden" name="id" class="form-control" value="<?php echo $data_adm->id?>"
                                    readonly>
                            </div>
                            ...
                            <center><a href="<?php echo base_url().'Admin/Dashboard';?>">Kembali Ke Beranda</a>
                            </center>
                        </div>
                        <?php echo form_close(); ?>
                    </div>
